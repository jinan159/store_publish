<?php session_start(); ?>
    <div style="text-align:cetner;">
        <a href="" id="downloadLink" target="new"><img id="qrcodeimg" style="display:none;" ></a>
    </div>
    <div style="text-align:cetner;">
        <p>
            <br>
    ...
    <script>
        $(document).ready(function () {
            var makeQRCodeUrl = "http://chart.apis.google.com/chart?cht=qr&chs=200&choe=UTF-8&chld=Hl0";
