    <div id="sidebar">
        <div class="inner">
            ...
            <!-- Search -->
                ...
                <div>
                    <?php if($_SESSION['s_grant_name']=='s') ?>
                    <h4>'<a href="myinfo.php?mode=<?=$_SESSION['s_grant_name']?>&email=<?=$_SESSION['s_email']?>"><?= $_SESSION['s_name'] ?></a>' 님 접속중</h4>
                    ...
                    <ul>										
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="#" class="o-menu" id="o-order-new">주문 추가</a></li>
                            </ul>
                        </li>										
                        <li>
    ...
    $('#a-stat-store').click(function() {
        location.href = "a-storeChart.php";
    });
    $('#a-stat-time').click(function() {
        location.href = "a-dateChart.php";
    });  
...
if(!isset($_SESSION['s_store_confirm']) || $_SESSION['s_store_confirm']!="y") {
    ...
    $('#o-order-new').click(function() {
        $("#banner").load("load/o-order-new.php");
    });
